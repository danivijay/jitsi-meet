...
export default class DeviceSelectionPopup {
    ...
    constructor(i18next) {
        ...
        this._dialogProps = {
            ...
            hasAudioPermission: JitsiMeetJS.mediaDevices
                .isDevicePermissionGranted.bind('audio'),
            hasVideoPermission: JitsiMeetJS.mediaDevices
                .isDevicePermissionGranted.bind('video'),
    ...
    _render() {
        const props = {
            ...
            onAudioPreviewUpdated: this._onAudioPreviewUpdated,
            onVideoPreviewUpdated: this._onVideoPreviewUpdated
        };
